...
Source0  : https://cpan.metacpan.org/authors/id/R/RJ/RJBS/Data-OptList-0.112.tar.gz
...
%prep
%setup -q -n Data-OptList-0.112
cd %{_builddir}
tar xf %{_sourcedir}/libdata-optlist-perl_0.110-1.debian.tar.xz
cd %{_builddir}/Data-OptList-0.112
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Data-OptList-0.112/deblicense/
...
cp %{_builddir}/Data-OptList-0.112/LICENSE %{buildroot}/usr/share/package-licenses/perl-Data-OptList/09c99293be0a7029d91f0c990e097696ca0e78de
