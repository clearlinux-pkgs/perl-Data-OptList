...
Version  : 0.113
Release  : 39
URL      : https://cpan.metacpan.org/authors/id/R/RJ/RJBS/Data-OptList-0.113.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/R/RJ/RJBS/Data-OptList-0.113.tar.gz
...
%prep
%setup -q -n Data-OptList-0.113
cd %{_builddir}
tar xf %{_sourcedir}/libdata-optlist-perl_0.110-1.debian.tar.xz
cd %{_builddir}/Data-OptList-0.113
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Data-OptList-0.113/deblicense/
